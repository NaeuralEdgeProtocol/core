# TODO Bleo: WIP
from core.serving.base import ContinousServingProcess as BaseServingProcess
...
class THTraining(BaseServingProcess, _PluginsManagerMixin):
  ...
  def _create_pipeline(self, path_to_dataset):
    ...
    _module_name, _class_name, _cls_def, _config_dict = self._get_module_name_and_class(
      locations=['local_libraries.nn.th.training.pipelines', 'plugins.serving.pipelines'],
      name=signature,

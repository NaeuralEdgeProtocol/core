...
from core.data.mixins_libs import _SqlQueryAcquisitionMixin
...
class SqlQueryDataCapture(DataCaptureThread, _SqlQueryAcquisitionMixin):
  ...
  def _init(self):
    ...
    if self.cfg_connector_type == 'PYMSSQL':
      from core.local_libraries.db_conn.pymssql_conn import PyMSSQLConnector
      config = {
        'CONNECT_PARAMS': {
      ...
      from core.local_libraries.db_conn.odbc_conn import ODBCConnector
      config = {
        'CONNECT_PARAMS': {
          'Encrypt': 'yes',

...
class PLUGIN_SEARCH:
  ...
  SAFE_LOC_CONFIG_PLUGINS = ['core.config.default']
  ...
  SAFE_LOC_SERVING_PLUGINS = ['core.serving.default_inference', 'core.serving.training', 'extensions.serving']
  SERVING_SAFE_IMPORTS = ['core.serving', 'extensions.serving']  # be aware that someone may drop some .py there and "validate" attacker code

  # BUSINESS
  LOC_BIZ_PLUGINS = ['plugins.business']
  SAFE_BIZ_PLUGINS = ['core.business.default', 'core.business.training', 'extensions.business']  # this is were the safe plugins are stored
  SAFE_BIZ_IMPORTS = ['core.business', 'extensions.business']  # be aware that someone may drop some .py there and "validate" attacker code
  SUFFIX_BIZ_PLUGINS = 'Plugin'

  # Heavy Ops
  SAFE_LOC_HEAVY_OPS_PLUGINS = 'core.heavy_ops.default'
  ...
  LOC_SAFE_FILE_SYSTEM_PLUGINS = ['core.remote_file_system.default']
...
# LOCATIONS
SENSORS_LOCATION = 'core.utils.sensors'
